...
https://github.com/mailchimp-open-commerce/api-server.git,api-server,v3.9.0 \
https://github.com/mailchimp-open-commerce/identity.git,identity,v3.2.0 \
https://github.com/mailchimp-open-commerce/admin.git,admin,v3.0.0-beta.9 \
